...
# === ULTRA HEALTH ENDPOINT (keeps Render alive + cron pings) ===
class HealthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        self.send_response(200)
        self.end_headers()
        self.wfile.write(b"PRO ULTRA ALIVE - 2025")
...
print("[ULTRA] Health server running on :10000")

# === CONFIG (ENV VARS) ===
YOUR_BOT_TOKEN = os.getenv("YOUR_BOT_TOKEN")
ADMIN_USER_ID = int(os.getenv("ADMIN_USER_ID", "7307757609"))
SELL_CHANNEL_ID = int(os.getenv("SELL_CHANNEL_ID", "-1003288341144"))
BOT_NAME = os.getenv("BOT_NAME", "@ccscraps123_bot")

COST_APPROVED = 2.0
COST_DECLINED = 1.0
CONCURRENCY_LIMIT = 3  # Pro Ultra can handle this

# Persistent disk on Pro/Ultra
DB_FILE = "/data/bisayakol.db" if os.path.exists("/data") else "/tmp/bisayakol.db"
